 ...
 */
export function instanceOfDeleteMonitoredItemsResponse(value: object): boolean {
    let isInstance = true;
...
export function DeleteMonitoredItemsResponseToJSON(value?: DeleteMonitoredItemsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
